...
export default function AppDemo() {
  ...
  const transactions = [
    {
      date: lt.lang === 'kz' ? '10 Нау' : (lt.lang === 'ru' ? '10 Мар' : 'Mar 10'), 
      time: '14:30',
    ...
    {
      date: lt.lang === 'kz' ? '09 Нау' : (lt.lang === 'ru' ? '09 Мар' : 'Mar 09'), 
      time: '16:40',
    ...
    {
      date: lt.lang === 'kz' ? '08 Нау' : (lt.lang === 'ru' ? '08 Мар' : 'Mar 08'), 
      time: '10:00',
    ...
    {
      date: lt.lang === 'kz' ? '07 Нау' : (lt.lang === 'ru' ? '07 Мар' : 'Mar 07'), 
      time: '09:20',
    ...
    {
      date: lt.lang === 'kz' ? '06 Нау' : (lt.lang === 'ru' ? '06 Мар' : 'Mar 06'), 
      time: '17:10',
